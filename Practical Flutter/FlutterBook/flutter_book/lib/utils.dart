...
// The application's document directory for contact avatar image files and
// database files, loaded on main().
...
Future selectDate(
  ...
  // If they didn't cancel, update it in the model so it shows on the screen
  // and return the string form.
  if (picked != null) {
